...
<body>
	...
	<div style="background-color: #E6F2F8;">
		<form action="user_logged_in.php" method="post">
			<table>
				<tr>
					<td colspan="2"><p style="font-size: 35px; color: #094198;"><b>Inicio de Sesion: Cliente</b></p></td>
				</tr>
				<tr>
					<td>N° de celular:</td>
					<td><input class="input" type="text" name="phone" placeholder="Introduzca su N° de celular" required></td>
					<br>
				</tr>
				<tr><td><br></td></tr>
				<tr>
					<td>Contraseña:</td>
					<td><input class="input" type="password" name="password" placeholder="Introduzca su contraseña" required></td>
				</tr>
			</table>
		<br>
		...
		<table>
			<tr>
				<td style="color: #094198;"><b>Eres nuevo?</b></td>
