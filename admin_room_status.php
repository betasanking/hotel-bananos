...
<html>
<head>
	<title>Estado de la sala de administración</title>
</head>
<style>
	body {
	  margin: 0;
	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			<table class="basic_box">
				<tr>
					<td colspan="6"><p style="font-size: 28px; text-align: center; text-decoration: underline;"><b>Estado de la sala de administración</b></p>
				</td>
				<tr>
			...
			<table class="basic_box">
				...
				<tr>
					<td></td>
					<td style="text-align: center;"><button type="submit">Confirmar</button>
  					<button type="submit" formaction="cancel_room.php">Cancelar reserva</button></td></form>	
				</tr>
			</table>
		</div>
	</body>
