...
<html>
<head>
	<title>Admin Añadir habitaciones</title>
</head>
<style>
	body {
	  margin: 0;
	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		...
		<?php
			...
			<div class="basic_box">
		  	<table>
				<tr>
					<th colspan="4"><p style="font-size: 28px; text-align: center; text-decoration: underline;">Añadir habitaciones</p></th>
				</tr>
				<tr>
			...
			<table>
				...
				<tr>
					<td style="text-align: left;">Introduzca el número de habitaciones que desea añadir:</td>
