...
<body>
	...
	<ul>
		<li><a href="user_view.php">Informacion Personal</a></li>
		<li><a href="bookroom.php">Reservar habitación</a></li>
		...
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			<div class="basic_box"><table>
				...
				<tr>
					...
					<td style="text-align: center;"><button type="submit">Pagar ahora</button></td>
				</tr>
