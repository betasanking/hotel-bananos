...
<html>
<head>
	<title>Confirmar reserva de habitación</title>
</head>
<style>
	body {
	  margin: 0;
...
<body>
	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p>La solicitud de reserva de habitación se ha enviado correctamente.!<br>Ahora espere a que el administrador confirme la solicitud.</p>
